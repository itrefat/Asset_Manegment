		...
		<div class="col-sm-10 col-sm-offset-1">
			<div class="widget-box">
				...
				<div class="widget-body">
							...
							<div class="col-sm-6">
								...
								<div>
									<ul class="list-unstyled spaced">
										<li>
											<i class="ace-icon fa fa-caret-right blue font-weight-bold"></i><b>BHML Industries Ltd.</b>
										</li>

										<li>
											<i class="ace-icon fa fa-caret-right blue"></i>Kamarjuri, Natun Bazar, National University, Gazipur
										</li>
                                        ...
                                        Contact:
											<b class="red">contact@bhml-bettex.com.bd</b>
										</li>
							...
							<div class="col-sm-6">
								...
								<div><br>
									<table class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            <th>{{$stores_info->namne}}</th>
                                            <th>{{ $stores_info->empid}}</th>
                                        </tr>
                    ...
                    <div class="bg-light">
                            <p>Issud By: BHML Industries Ltd.</p>
                    </div>
				</div>
			</div>         
		</div>
